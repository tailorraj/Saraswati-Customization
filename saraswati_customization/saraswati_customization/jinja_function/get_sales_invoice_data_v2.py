...
@frappe.whitelist()
def get_sales_invoice_data_with_letter_head_v2(doc, letter_head, footer,print_settings):
    ...
    html = frappe.render_template("templates/saraswati_sales_invoice_v2.html",{"doc":estimate_doc, "items": doc_items, "letter_head": letter_head,"footer":footer,"print_settings":print_settings_doc})
    return html
